                    ...
                    if (type.equals("Dry Cleaning")) {
                        ...
                        if (!myQuantity.isEmpty()) {
                            ...
                            if (!itemCode.isEmpty()) {
                                ...
                                Toast.makeText(EditInventoryActivity.this, "Choose another category", Toast.LENGTH_SHORT).show();
                            }
...
//        countryList.add(new CountryItem("", , , ));
    ...
    void updateItem(){
        ...
        App.supportService.updateInventory(item.getId(),actGarment.getText().toString(),
                amount,type,"UpdateInventory", currentPrice,currentCode).enqueue(new Callback<Inventory>() {
            @Override
